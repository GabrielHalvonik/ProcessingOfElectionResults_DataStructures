...
namespace Structures {
	...
	ADSFactory::ADSFactory(StructureADS ads, Structure *prototype) :  ads_(ads), prototype_(prototype), clones_(new vector<Structure*>), totalCreated_(0) {
    }
	...
	ADTFactoryManager::ADTFactoryManager(StructureADT adt) : adt_(adt), adsFactories_(new vector<ADSFactory*>), producedStructures_(new vector<StructureOrigin>) {
    }
	...
	StructureFactory::StructureFactory() : adtManagers_(new vector<ADTFactoryManager*>) {
